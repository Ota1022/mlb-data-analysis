...
# Create a BeautifulSoup object to parse the HTML content
    ...
    for row in rows[1:26]:
        ...
        player_url = 'https://baseballsavant.mlb.com/savant-player'+'/'+str.lower('-'.join(player_name.replace(".","").split(' ')))+'-'+player_id+'?stats=gamelogs-r-hitting-mlb&season='+str(season) 
        url_year='https://www.mlb.com/player/'+str.lower('-'.join(player_name.replace(".","").split(' ')))+'-'+player_id+'?stats=gamelogs-r-hitting-mlb&year=2019'
